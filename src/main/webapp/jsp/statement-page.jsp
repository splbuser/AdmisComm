...
<head>
    ...
    <title><fmt:message key="label.manage_statement"/></title>
...
<div class="container-fluid" style="margin-top: 75px;font-family: 'Noto Sans', sans-serif;">
    <h3 class="text-light mb-4" style="font-family: 'Noto Sans', sans-serif;text-align: center;"><fmt:message
            key="label.manage_statement"/></h3>
    <div class="card shadow" style="background: rgb(99,99,99);border-radius: 20px;">
        <form method="post">
        <div class="card-header py-3">
            <button class="btn btn-primary" type="submit" style="border-radius: 8px;"><fmt:message key="button.finalize"/></button>
                                ...
                                <div class="dropend">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-dark"
                                         style="border-radius: 8px;min-width: 60px;"><a class="dropdown-item"
                                                                                        href="?type=ASC&sortBy=byFaculty"><fmt:message key="label.sort_up"/></a><a
                                            class="dropdown-item" href="?type=DSC&sortBy=byFaculty"><fmt:message key="label.sort_down"/></a></div>
                                </div>
                                <div class="dropend">
                                    <button class="dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown"
                                            type="button"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-dark"
                                         style="border-radius: 8px;min-width: 60px;"><a class="dropdown-item"
                                                                                        href="?type=ASC&sortBy=byLastName"><fmt:message key="label.sort_up"/></a><a
                                            class="dropdown-item" href="?type=DSC&sortBy=byLastName"><fmt:message key="label.sort_down"/></a></div>
                                </div>
                                <div class="dropend">
                                    <button class="dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown"
                                            type="button"
                                            style="background: rgba(255,255,255,0);color: rgb(255,255,255);border-style: none;">
                                        <fmt:message key="label.total_score"/>
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-dark"
                                         style="border-radius: 8px;min-width: 60px;"><a class="dropdown-item"
                                                                                        href="?type=ASC&sortBy=byTotalScore">0-9</a><a
                                            class="dropdown-item" href="?type=DSC&sortBy=byTotalScore">9-0</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                <table class="table my-0" id="dataTable">
                    ...
                    <tr>
                        <td><p>${list.faculty.name}</p></td>
                        <td><p>${list.applicant.lastName} ${list.applicant.firstName}</p></td>
                        <td><p>${list.totalScore}</p></td>
                    </tr>
                    </c:forEach>
                    </tbody>
                    <tfoot>
                    <tr>
                        ...
                        <td><strong><fmt:message key="label.total_score"/><br></strong></td>
                    </tr>
                    </tfoot>
                </table>
            </div>
